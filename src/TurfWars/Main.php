...
class Main extends PluginBase implements Listener
{
    ...
    public $games = [
        "Game1" => ["Arena" => "TW-1", "Status" => "JOINABLE", "RedScore" => 0, "BlueScore" => 0],
        "Game2" => ["Arena" => "TW-2", "Status" => "JOINABLE", "RedScore" => 0, "BlueScore" => 0],
        "Game3" => ["Arena" => "TW-3", "Status" => "JOINABLE", "RedScore" => 0, "BlueScore" => 0],
        "Game4" => ["Arena" => "TW-4", "Status" => "JOINABLE", "RedScore" => 0, "BlueScore" => 0],
        "Game5" => ["Arena" => "TW-5", "Status" => "JOINABLE", "RedScore" => 0, "BlueScore" => 0],
        "Game6" => ["Arena" => "TW-6", "Status" => "JOINABLE", "RedScore" => 0, "BlueScore" => 0],
        "Game7" => ["Arena" => "TW-7", "Status" => "JOINABLE", "RedScore" => 0, "BlueScore" => 0],
        "Game8" => ["Arena" => "TW-8", "Status" => "JOINABLE", "RedScore" => 0, "BlueScore" => 0],
        "Game9" => ["Arena" => "TW-9", "Status" => "JOINABLE", "RedScore" => 0, "BlueScore" => 0],
        "Game10" => ["Arena" => "TW-10", "Status" => "JOINABLE", "RedScore" => 0, "BlueScore" => 0],
    ];
        ...
        if ($this->inTurfWars($player = $event->getEntity()->shootingEntity)) {
            if ($this->games[$this->getGameByPlayer($player) ]["Status"] != "INGAME") {
                ...
                if ($this->config->get("Enable_PC_Arrow_Mechanics")) {
                    $event->getEntity()->setMotion(new Vector3(-\sin($player->yaw / 180 * M_PI) * \cos($player->pitch / 180 * M_PI),
    ...
    public function onMove(PlayerMoveEvent $event)
    {
        if ($this->inTurfWars($player = $event->getPlayer())) {
            if (!(
                ...
                $this->games[$this->getGameByPlayer($player)]["Status"] == "JOINABLE" ||
    ...
    public function GameSetup($player, $Arena)
    {
        ...
        $Players = $this->getServer()
            ->getLevelByName($Arena)->getPlayers();
        ...
        if (count($this->getServer()
            ->getLevelByName($Arena)->getPlayers()) == 2 /*$this->maps->get($Arena."_max")*/) {
